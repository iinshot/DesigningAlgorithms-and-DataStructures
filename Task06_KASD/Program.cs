...
public class MyVector<T>
{
    ...
    // 10
    public void RemoveObj(object element)
    {
        if (Contains(element))
        {
            int flag = 0;
...
class Programm
{
    ...
    {
        MyVector<int> array = new MyVector<int>(20);
        ...
        array.Clear();
        array.ContainsAll(newArray);
        array.IsEmpty();
        array.RemoveObj(4);
        array.RemoveAll(newArray);
        array.RetainAll(newArray);
        array.ToArray();
        array.ToArray(newArray);
        array.AddInd(1, 5);
        array.AddAllInd(2, newArray);
        array.Get(2);
        array.IndexOf(3);
        array.Remove(5);
        array.Set(6, 5);
        array.SubList(1, 7);
        Console.WriteLine(array.elementCount);
    }
}