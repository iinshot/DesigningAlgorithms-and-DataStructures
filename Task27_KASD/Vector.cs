...
{
    public MyIterator2<T> ListIterator() => new MyItr(this);
    public MyIterator2<T> ListIterator(int index) => new MyItr(this, index);
    public class MyItr : MyIterator2<T>
    {
        ...
        public void Set(T element) => list.elementData[index] = element;
